...
int order ()
{
    ...
    gets (p[order_count].email);
    printf("Enter Your Pass : ");
    gets (p[order_count].pass);
    printf("Enter Your Address : ");
    gets (p[order_count].add);
    ...
    while (1){
        ...
        switch (in){
            ...
            case 4 : {
                ...
                printf ("Project submitted by Team  < WE FIVE >   \n\n");
                printf ("Our hearty gratitude to honorable teacher  \n\n");
                printf ("         MOHAMMAD ABU YOUSUF          \n");
                printf ("\n       DEVELOPED BY < WE FIVE >  \n\n");
                return 0;
            }
        }
    }
